...
<script src="https://code.jquery.com/jquery-3.1.1.slim.min.js" integrity="sha384-A7FZj7v+d/sdmMqp/nOQwliLvUsJfDHW+k9Omg/a/EheAdgtzNs3hpfag6Ed950n" crossorigin="anonymous"></script>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js" integrity="sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn" crossorigin="anonymous"></script>    <script src="js/wow.min.js" charset="utf-8"></script>
	<script>
		wow = new WOW({
			mobile: false,
		})
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="booking-form" style="text-align: center;">
            <div class="f30 robsl bold" width="100%">Оставьте заявку</div>
            <div class="f19">Наш квалифицированный сотрудник свяжется с Вами в ближайшее время</div>
            <form action="/send.php" method="post">
                ...
                <button class="btn-prim robsl bold f19" type="submit">Отправить</button>
            </form>
            ...
            <ul class="consult">
                ...
                <li>
                    <div class="row justify-content-left">
                        <div class="col-1"></div>
                        <div class="col-11"><button class="btn btn-prim robsl bold" style="font-size: 1em;" data-toggle="modal" data-target="#exampleModal">Оставить заявку</button></div>
                    </div>
                </li>
            </ul>
        </div>
                ...
                <div class="col shipping" style="max-width: 1000px; background: url(img/delivery.png) center/cover no-repeat; padding: 100px;">
                    <div class="row justify-content-center align-items-center">
                        <div class="col col-big">
                            ...
                            <a href="https://kitchen.alba.com.ua//#callbackhunter" class="btn btn-prim robsl bold"  data-toggle="modal" data-target="#exampleModal">Консультация</a>
                        </div>
...
<div class="container steps" style="padding: 100px 0;">
    <div class="row justify-content-between align-items-center">
        <div class="col col-min one-click">
            ...
            <a  data-toggle="modal" data-target="#exampleModal" class="btn btn-empty robsl bold" style="position: relative;z-index: 5;">Оставить заявку</a>
        </div>
...
<div class="footer">
    <div class="ftr_head container justify-content-between bold">
        ...
        <a href="" class="btn btn-empty"  data-toggle="modal" data-target="#exampleModal">Заказать звонок</a>
    </div>
